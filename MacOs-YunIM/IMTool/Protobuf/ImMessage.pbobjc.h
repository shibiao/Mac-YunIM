...
typedef GPB_ENUM(IMMsgData_FieldNumber) {
  ...
  IMMsgData_FieldNumber_Seq = 5,
  IMMsgData_FieldNumber_MsgId = 6,
  IMMsgData_FieldNumber_MsgData = 7,
  IMMsgData_FieldNumber_RcvId = 8,
  IMMsgData_FieldNumber_CreateTime = 9,
};
...
/// 消息下发
@property(nonatomic, readwrite, copy, null_resettable) NSString *rcvId;
...
typedef GPB_ENUM(IMMsgDataAck_FieldNumber) {
  ...
  IMMsgDataAck_FieldNumber_AckTo = 4,
  IMMsgDataAck_FieldNumber_CreateTime = 5,
};
...
/// 消息发送时的seq
@property(nonatomic, readwrite, copy, null_resettable) NSString *ackTo;
...
typedef GPB_ENUM(IMMsgDataRead_FieldNumber) {
  IMMsgDataRead_FieldNumber_Uid = 1,
  IMMsgDataRead_FieldNumber_Cid = 2,
  IMMsgDataRead_FieldNumber_MsgId = 3,
  IMMsgDataRead_FieldNumber_OriginUid = 4,
  IMMsgDataRead_FieldNumber_MsgSubtype = 5,
  IMMsgDataRead_FieldNumber_UnreadCnt = 6,
};

/// 已读确认
@interface IMMsgDataRead : GPBMessage
...
/// 已读消息的原始发送人
@property(nonatomic, readwrite, copy, null_resettable) NSString *originUid;

/// 已读消息的类型（扩展用，可以对bot信息做进特殊处理)
@property(nonatomic, readwrite, copy, null_resettable) NSString *msgSubtype;

/// 消息未读数
@property(nonatomic, readwrite) int32_t unreadCnt;
